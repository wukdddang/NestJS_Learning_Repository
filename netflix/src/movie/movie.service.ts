...
import { Like, Repository, In, DataSource } from 'typeorm';
...
export class MovieService {
  ...
  async update(id: number, updateMovieDto: UpdateMovieDto) {
    ...
    try {
      ...
      // 3. genres 관계 업데이트는 save 메소드를 사용
